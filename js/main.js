...
document.addEventListener("DOMContentLoaded", function() {
    const headers = [
        {text: "AidNexus: A Digital Blockchain Passport Securing Refugees Records.", subtext: `Empowering Refugees With Hope, Dignity, And Support In A Digital Age.`},
        {text: "One Empowering Platform, Simplified & Secure Complete Records, Unwavering Trust.", subtext: "The Single Source And Version Of Truth For Refugee's Records Across Their Journey."},
        {text: "From Displacement to Resettlement: \nEmpowering Refugees with Dignity.", subtext: "Humanizing The Refugee Journey And Experience. A Future Enabled."},
